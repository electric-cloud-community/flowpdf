...
class ECConfluenceRESTClient {

    private static String BEARER_PREFIX = 'Bearer'
    private static String USER_AGENT = 'ECConfluenceRESTClient REST Client'
    ...
    ECConfluenceRESTClient(String endpoint, RESTConfig restConfig, FlowPlugin plugin) {
    ...
    /**
     * Will create a ECConfluenceRESTClient object from the plugin Config object.
     * Convenient as it can use pre-defined configuration fields.
     */
    static ECConfluenceRESTClient fromConfig(Config config, FlowPlugin plugin) {
        Map params = [:]
        ...
        return new ECConfluenceRESTClient(endpoint, restConfig, plugin)
    }
    ...
    /** Generated code for the endpoint /wiki/rest/api/content
    ...
    * Content: in body
    */
    def createPage(Map<String, String> params) {
        this.method = 'createPage'
        this.methodParameters = params

        String uri = '/wiki/rest/api/content'
        ...
        payload.put('SpaceKey', params.get('SpaceKey'))

        payload.put('Title', params.get('Title'))

        payload.put('Ancestors', params.get('Ancestors'))

        payload.put('Content', params.get('Content'))
...
// DO NOT EDIT THIS BLOCK === rest client ends, checksum: 0ef57ffa5e69fe4df442fbf2ad560209 ===
    /**
